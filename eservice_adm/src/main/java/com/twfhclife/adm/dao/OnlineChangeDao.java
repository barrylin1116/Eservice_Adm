...
public interface OnlineChangeDao {
    ...
    MedicalTreatmentClaimFileDataVo getMedicalInfoClaimFile(@Param("id") Float id);

	MedicalTreatmentClaimFileDataVo getMedicalInfoClaimFileData(@Param("id") Float id);
}
